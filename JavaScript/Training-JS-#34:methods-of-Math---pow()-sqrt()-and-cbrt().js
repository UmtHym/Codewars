...
//Explanation  
  //First we make sure that the number of cubes can create a cube form by taking n's cuberoot and making sure that it is an integer and not a float by taking its % 1,
  //Second we take the cuberoot of the single divided cube to know its lenght and again % 1 for the integer check.